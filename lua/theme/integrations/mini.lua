...
return function(theme, color)
    return {
        ...
        highlight = {
            ...
            spec.co("MiniStatuslineModeNormal", color.gray7, theme.ui.bg_statusline, { bold = true }),
            ...
            spec.co("MiniStatuslineFilename", color.gray7, theme.ui.bg_statusline),
            spec.co("MiniStatuslineFileinfo", color.gray7, theme.ui.bg_statusline),
            spec.co("MiniStatuslineDevinfo", color.gray7, theme.ui.bg_statusline),
