...
---@class ThemeHighlightGroup
---@field plugin_name ?string
---@field dont_skip ?boolean -- force highlights to run if true
---@field highlight ThemeHighlightSpec[]
    ...
    return {
        {
            ...
            highlight = {
                ...
                -- NON TEXT
                spec.fg("NonText", theme.ui.fg_nontext),
                ...
                spec.co("Comment", theme.syntax.comment, theme.none, theme.styles.comments),
                spec.co("SpecialComment", theme.syntax.comment, theme.none, theme.styles.comments),
                ...
                spec.co("@comment.documentation", theme.syntax.comment, theme.none, theme.styles.comments),
        ...
        require("theme.integrations.cmp")(theme),
        require("theme.integrations.flash")(theme),
        require("theme.integrations.git-gutter")(theme),
        require("theme.integrations.git-signs")(theme),
        require("theme.integrations.lazy")(theme),
        require("theme.integrations.lightbulb")(theme),
        require("theme.integrations.lsp-config")(theme),
        require("theme.integrations.mason")(theme),
        require("theme.integrations.oil")(theme),
        require("theme.integrations.rainbow-delimiter")(theme),
        require("theme.integrations.telescope")(theme),
        require("theme.integrations.todo-comments")(theme),
        require("theme.integrations.tree")(theme),
        require("theme.integrations.trouble")(theme),
        require("theme.integrations.which-key")(theme),
        require("theme.integrations.notify")(theme),
        require("theme.integrations.navic")(theme),
        require("theme.integrations.yanky")(theme),
        require("theme.integrations.headlines")(theme),
        require("theme.integrations.noice")(theme),
        require("theme.integrations.dashboard")(theme),
        require("theme.integrations.scrollbar")(theme),
        require("theme.integrations.bufferline")(theme, color),
        require("theme.integrations.indentmini")(theme, color),
        -- TODO: decide if each individual mini plugin should be opt in
        -- can wait until all are supported before deciding
        require("theme.integrations.mini")(theme, color),
    }
end
