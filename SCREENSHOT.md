...
> [!NOTE]
> These are historical visual references retained from the upstream Lackluster foundation. `theme.nvim` exposes only `:colorscheme lackluster`; the former variant names shown below are not colorscheme entry points.
